...
class UserUtils(object):
  ...
  def check_user_exists(self, browser):
    ...
    does_user_exist = AbstractBrowserBasedTest.find_or_wait_until(func, "check user account")
  ...
  def create_user(self, browser):
    ...
    is_account_created = AbstractBrowserBasedTest.find_or_wait_until(func, "creating account")
